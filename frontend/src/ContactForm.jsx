...
const ContactForm = ({ existingContact = {}, updateCallback }) => {
    ...
    return <form onSubmit={onSubmit}>
        ...
        <div className="form-group">
            ...
            <input type="text" placeholder="Enter Email Address" id="email" value={email} onChange={(e) => setEmail(e.target.value)}/>
        </div>
        <button type="submit" className="update-create-btn">{updating ? "Update" : "Create"}</button>
    </form>
}
